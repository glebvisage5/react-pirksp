...
import { GraduationCap, Mail, Lock, User, Eye, EyeOff, Building, ArrowLeft, Home } from "lucide-react";
...
export function Register({ onRegister, onSwitchToLogin, onBackToCompany, onBackToLanding }: Props) {
  ...
  const t = {
    title: language === "en" ? "Create Account" : "Создать аккаунт",
    description: language === "en" ? "Fill in your details to register" : "Заполните данные для регистрации",
    welcome: language === "en" ? "Create your account and get started today!" : "Создайте аккаунт и начните сегодня!",
    fullName: language === "en" ? "Full Name" : "Полное имя",
    email: language === "en" ? "Email" : "Электронная почта",
    institution: language === "en" ? "Institution Name" : "Название учреждения",
    password: language === "en" ? "Password" : "Пароль",
    confirmPassword: language === "en" ? "Confirm Password" : "Подтвердите пароль",
    terms: language === "en" 
    ...
    haveAccount: language === "en" ? "Already have an account? " : "Уже есть аккаунт? ",
